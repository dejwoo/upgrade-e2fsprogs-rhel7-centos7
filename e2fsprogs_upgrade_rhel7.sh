...
remove() {
    rpm -e e2fsprogs-1.42.9-16.el7.x86_64 --nodeps
    rpm -e e2fsprogs-libs-1.42.9-16.el7.x86_64 --nodeps
    rpm -e libss-1.42.9-16.el7.x86_64 --nodeps
    rpm -e libcom_err-1.42.9-16.el7.x86_64 --nodeps
}
